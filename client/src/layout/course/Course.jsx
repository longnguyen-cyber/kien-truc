...
const Course = () => {
  const [filter, setFilter] = useState('2-2021')
      ...
      <div className="mx-auto w-3/4 mt-4 border text-center p-2">
        ...
        <button
          onClick={() => {
            ...
            const data = {
              class_id: selectedFinal.class_id,
              class_detail_id: selectedFinal.class_detail_id,
            }
            CourseApi.enrollCourse(data).then((res) => {
              if (res.status === 201) {
